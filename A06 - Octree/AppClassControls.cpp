...
void Application::ProcessKeyReleased(sf::Event a_event) {
	...
	switch (a_event.key.code) {
		...
		case sf::Keyboard::PageUp:
			Octree::s_iDisplayOctant++;
			if (Octree::s_iDisplayOctant > 0 && Octree::s_iDisplayOctant > Octree::s_uOctantCount) {
				Octree::s_iDisplayOctant = Octree::s_uOctantCount;
			}
			break;
		case sf::Keyboard::PageDown:
			Octree::s_iDisplayOctant--;
			if (Octree::s_iDisplayOctant < -2) {
				Octree::s_iDisplayOctant = -2;
			}
			break;
		case sf::Keyboard::Add:
			if (Octree::s_uMaxLevel < 5) {
				Octree::s_iDisplayOctant = -1;
				Octree::s_uMaxLevel++;
				Octree::s_bShouldRebuild = true;
			}
			break;
		case sf::Keyboard::Return:
			m_bRealtimeOctreeActive = !m_bRealtimeOctreeActive;
			Octree::s_iDisplayOctant = -1;
			break;
		case sf::Keyboard::Subtract:
			if (Octree::s_uMaxLevel > 0) {
				Octree::s_iDisplayOctant = -1;
				Octree::s_uMaxLevel--;
				Octree::s_bShouldRebuild = true;
			}
